        ...
        <tr>
            <td colspan="7" class="text-center">
                <div style="padding: 20px;">
                    ...
                    <p class="mt-2" style="font-weight: bold;">Данные отсутствуют</p>
                </div>
            </td>
        </tr>
    @else
        @foreach ($datas as $index => $data)
            <tr id="tr_{{ $data->id }}">
                ...
                <td align="center">
                    <a href="{{ route('admin.vocabularies.edit', [$data]) }}" title="Изменить"
                       class="btn btn-xs btn-info">
                        <span class="glyphicon glyphicon-pencil"></span>
                    </a>
                    <a class="deleteModal btn btn-xs btn-danger" style="margin-left: 3px;"
                       onclick="deleteModel('/admin/vocabularies/{{ $data->id }}/destroy')">
